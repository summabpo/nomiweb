...
class Contratos(models.Model):
    ...
    tipocontrato = models.CharField(max_length=40, blank=True, null=True)
    ...
    centrotrabajo = models.CharField(max_length=30, blank=True, null=True)
    ...
    jornada = models.CharField(max_length=16, blank=True, null=True)
