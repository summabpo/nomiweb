...
urlpatterns = [
    ...
    path('payroll/new/disabilities/download/', disabilities.export_disabilities_excel, name='export_disabilities_excel'),
    ...
    path('payroll/vacation/resumen/download/', vacation_general.export_vacation_resumen_excel, name='export_vacation_resumen_excel'),
    path('payroll/vacation/resumen/doc/<int:id>/', vacation_general.vacation_resumen_doc, name='vacation_resumen_doc'),
    path('payroll/vacation/resumen/master/<int:idvacmaster>/lines/', vacation_general.vacation_master_lines, name='vacation_master_lines'),
    path('payroll/absences/resumen/', vacation_general.absences_resumen, name='absences_resumen'),
    path('payroll/absences/resumen/download/', vacation_general.export_absences_excel, name='export_absences_excel'),
...
urlunpolypatterns =[
    ...
    path('payroll/absences/resumen/<str:id>/send', vacation_general.absences_resumen_send, name='absences_resumen_send'),
