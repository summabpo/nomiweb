...
class ReactivationForm(forms.Form):
    ...
    def __init__(self, *args, **kwargs):
        ...
        idcontrato = kwargs.pop('idcontrato', None)
        super(ReactivationForm, self).__init__(*args, **kwargs)   
        
        
        self.fields['name'] = forms.ChoiceField(
            choices=[('', '----------')] + [(employee.idempleado, f" {employee.pnombre} {employee.papellido} " ) for employee in Contratosemp.objects.filter(id_empresa__idempresa = idempresa )], 
            label='Empleado' ,
        ...
        self.helper.form_method = 'post'
        self.helper.form_class = 'container'
        self.helper.form_id = 'form_Reactivation'
        self.helper.enctype = 'multipart/form-data'
        ...
        self.helper.attrs.update({
            ...
            'up-mode': 'replace',
            'up-layer': 'current',
            'up-submit': reverse('companies:reactivation_modal', kwargs={'id': idcontrato}),
            'up-accept-location': reverse('companies:reactivation_modal', kwargs={'id': idcontrato}),
        })
