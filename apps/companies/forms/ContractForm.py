...
#     # Información Adicional
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.fields['CesanFund'] = forms.ChoiceField(choices=[('', '----------')] + [(entidad.codigo, entidad.entidad) for entidad in Entidadessegsocial.objects.filter(tipoentidad='CCF').order_by('entidad')], label='Fondo Cesantias', required=True , widget=forms.Select(attrs={'data-control': 'select2'})) 
