        ...
        if form.is_valid():
            ...
            for data in nominas:
                ...
                if docidentidad not in acumulados:
                    ...
                    # # Calcular la base para las prestaciones sociales
                    # base_ss = Nomina.objects.filter(
                    #     idconcepto__basesegsocial=1,  # Referencia a través de la relación ForeignKey
                    #     mesacumular=mes,
                    #     anoacumular=año,
                    #     idcontrato=docidentidad
                    ...
                    # base_arl = Nomina.objects.filter(
                    #     idconcepto__baserarl=1,  # Referencia a través de la relación ForeignKey
                    #     mesacumular=mes,
                    #     anoacumular=año,
                    #     idcontrato=docidentidad
                    # ).aggregate(Sum('valor'))['valor__sum'] or 0
                    ...
                    # base_caja = Nomina.objects.filter(
                    #     idconcepto__basecaja=1,  # Referencia a través de la relación ForeignKey
                    #     mesacumular=mes,
                    #     anoacumular=año,
                    #     idcontrato=docidentidad
                    # ).aggregate(Sum('valor'))['valor__sum'] or 0
                    ...
                    # pension_t = Nomina.objects.filter(
                    #     idconcepto__idconcepto=70 ,  # Referencia a través de la relación ForeignKey
                    #     mesacumular=mes,
                    #     anoacumular=año,
                    #     idcontrato=docidentidad
                    # ).aggregate(Sum('valor'))['valor__sum'] or 0
                    ...
                    # pension_ft = Nomina.objects.filter(
                    #     idconcepto__idconcepto=90,  # Referencia a través de la relación ForeignKey
                    #     mesacumular=mes,
                    #     anoacumular=año,
                    #     idcontrato=docidentidad
                    # ).aggregate(Sum('valor'))['valor__sum'] or 0
                    ...
                    # salud_t = Nomina.objects.filter(
                    #     idconcepto__idconcepto=60,  # Referencia a través de la relación ForeignKey
                    #     mesacumular=mes,
                    #     anoacumular=año,
                    #     idcontrato=docidentidad
                    # ).aggregate(Sum('valor'))['valor__sum'] or 0
                    ...
                    # variable = base_ss - Nomina.objects.filter(
                    #     Q(idconcepto__sueldobasico=1) | Q(idconcepto__salintegral=1) | Q(idconcepto__incapacidad=1) | Q(idconcepto__idconcepto=24),
                    #     mesacumular=mes,
                    #     anoacumular=año,
                    #     idcontrato=docidentidad
                    # ).aggregate(Sum('valor'))['valor__sum'] or 0
                    ...
                    # suspension = Nomina.objects.filter(
                    #     idconcepto__suspcontrato=1,  # Referencia a través de la relación ForeignKey
                    #     mesacumular=mes,
                    #     anoacumular=año,
                    #     idcontrato=docidentidad
                    # ).aggregate(Sum('valor'))['valor__sum'] or 0
